                ...
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                    ...
                    <div className="mt-2">
                      {odisRegistedAddresses ? (
                        ...
                        <p className="text-sm text-gray-500">
                          Please register your username with your social network
                          to continue with TruWork.
                        </p>
                      )}
                  ...
                  <div className="mt-4 w-full flex justify-between">
                    <button
                      ...
                      type="button"
                      className="text-white bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-500 dark:hover:bg-orange-700/30"
                    >
                      <svg
